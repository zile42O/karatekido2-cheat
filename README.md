...
## Copy whole code Developer console on website (f12 > Console)
* Change const variables for your statistic
* Change uuid find it in cookies section on website it's called uuid (example: 8c277b51-782d-4801-89b4-9295492dasfs)
```js
const playTime = 32; //change
const SCORE = 420; //change
const blockCnt = 1337; //change

setScore(SCORE, playTime, blockCnt);
...
async function getAuthToken() {
    ...
    const getUUID = 'FILL_THIS_IS_REQUIRED';
    ...
    data = {
        ...
        "params": {
            "gameplayData": {
                ...
                "createdTime": today.toISOString().split('.')[0] + "+01:00",
